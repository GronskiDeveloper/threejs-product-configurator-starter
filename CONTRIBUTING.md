# Jak współtworzyć — Three.js Product Configurator Starter

Chętnie przyjmę pull requesty i sensowne issue.

## Zanim otworzysz issue

1. **Sprawdź [otwarte issue](https://github.com/GronskiDeveloper/threejs-product-configurator-starter/issues)** — może już ktoś to zgłosił.
